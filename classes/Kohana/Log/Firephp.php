...
class Kohana_Log_Firephp extends Log_Writer {
	...
	public function __construct(array $options = array())
	{
        ...
        $enabled = Arr::get($options, 'enabled', false);
        $this->_fire->setEnabled($enabled);

        $this->_fire->setOptions($options['options']);
	}
	...
	{
        $options = [];
		$this->_fire->log($session->as_array(), 'Session', $options);
	}
